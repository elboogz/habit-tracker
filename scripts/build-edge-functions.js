...
// same business logic (dayKey, addDays, isDoneOnDay, streakForHabit, consistency today; more as
// Phase 5 needs it) is never hand-duplicated a third time. See
...
const SOURCES = [
  ...
  { file: 'habit-stats.ts', names: ['logsForHabitOnDay', 'countForDay', 'isDoneOnDay', 'streakForHabit', 'DayStatus', 'recentHistory', 'consistency'] },
];
